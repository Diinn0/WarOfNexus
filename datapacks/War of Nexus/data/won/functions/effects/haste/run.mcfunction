...
execute if entity @s[team=red] run effect give @a[team=red] haste 120 0
execute if entity @s[team=blue] run effect give @a[team=blue] haste 120 0
execute if entity @s[team=green] run effect give @a[team=green] haste 120 0
execute if entity @s[team=yellow] run effect give @a[team=yellow] haste 120 0