...
execute if entity @s[team=red] run effect give @a[team=red] strength 60 0 true
execute if entity @s[team=blue] run effect give @a[team=blue] strength 60 0 true
execute if entity @s[team=green] run effect give @a[team=green] strength 60 0 true
execute if entity @s[team=yellow] run effect give @a[team=yellow] strength 60 0 true